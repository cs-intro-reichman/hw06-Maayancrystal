...
public class Runigram {
	...
	public static Color luminance(Color pixel) {
		int lumRGB =  (int)(pixel.getRed() * 0.299 + pixel.getGreen() * 0.587 + pixel.getBlue() * 0.114);
		if (lumRGB > 255){
			lumRGB = 255;
		}
		if (lumRGB < 0) {
		...
		Color newColor = new Color(lumRGB , lumRGB , lumRGB);
		return newColor;
	}
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		for (int i = 0 ; i  < scaledImage.length ; i++){
			for(int j = 0 ; j < scaledImage[0].length ; j++){
				sourcei = (int)(i * ((double)image.length / height));
				sourcej = (int)(j * ((double)image[0].length / width));
	...
	public static Color blend(Color c1, Color c2, double alpha) {
		...
		int red = (int)((double)c1.getRed() * alpha + c2.getRed() * minusAlpha);
		int green = (int)((double)c1.getGreen() * alpha + c2.getGreen() * minusAlpha);
		int blue = (int)((double)c1.getBlue() * alpha + c2.getBlue() * minusAlpha);
